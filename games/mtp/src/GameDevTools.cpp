...
void Game::updateDevTools(float dt)
{
    ...
    Im3dText(pos, 1.f, glm::vec4{1.f}, "Cato");
    ...
    /* Im3dDrawArrow(glm::vec4{1.f, 0.f, 0.f, 1.f}, pos, pos + glm::vec3{1.f, 0.f, 0.f});
    Im3dDrawArrow(glm::vec4{0.f, 1.f, 0.f, 1.f}, pos, pos + glm::vec3{0.f, 1.f, 0.f});
    Im3dDrawArrow(glm::vec4{0.f, 0.f, 1.f, 1.f}, pos, pos + glm::vec3{0.f, 0.f, 1.f}); */
